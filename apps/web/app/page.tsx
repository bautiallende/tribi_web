  ...
  return (
    <main className="w-full">
      ...
      <section className="py-20 sm:py-32">
        <div className="container-max">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Trusted by Major Carriers</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {popularCarriers.map((carrier, index) => (
              <div key={index} className="flex items-center justify-center p-6 bg-slate-50 dark:bg-slate-900 border border-border rounded-xl hover:shadow-md hover:border-primary-200 dark:hover:border-primary-800 transition-all">
      ...
      <section className="py-20 sm:py-32 bg-slate-50 dark:bg-slate-900/50">
        <div className="container-max text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to Travel Connected?</h2>
